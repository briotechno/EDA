  ...
  return (
    <Box sx={{
      ...
      <Box sx={{ display: "flex", gap: "30px", flexDirection: "column", color: "#E2CAA2", fontFamily: "Lato" }}>
        ...
        <Box>
          <Box sx={{ mb: 2, border: `1px solid #E2CAA2`, borderRadius: "5px" }}>
            <Accordion
            ...
            >
              ...
              <AccordionDetails>
                <Typography variant="body1" sx={{ fontSize: "18px", color: "#E2CAA2" }}>
                  Die EDA – Baumanagement GmbH, Eppeleinstr. 2, 92353 Postbauer Heng,
                  ist als Betreiberin dieser Webseite:{" "}
                  <Link
                    href="http://www.eda-baumanagement.com"
                    target="_blank"
                    rel="noopener noreferrer"
                    sx={{ color: "#E2CAA2", textDecoration: "underline" }}
                  >
                    http://www.eda-baumanagement.com
                  </Link>{" "}
                  verantwortliche Stelle (Verantwortlicher) im Sinne der Europäischen
                  Datenschutz-Grundverordnung (DS-GVO), die allein oder gemeinsam mit
            ...
            >
              ...
              <AccordionDetails>
                ...
                <Typography
                  variant="body1"
                  pargraph
                  sx={{ mb: 1, fontSize: "22px", color: "#E2CAA2" }}
                >
                  <strong>Umfang der Verarbeitung personenbezogener Daten</strong>
                </Typography>
                <Typography variant="body1" pargraph sx={{ fontSize: "18px", color: "#E2CAA2" }}>
                ...
                <ul style={{ fontSize: "20px", color: "#E2CAA2" }}>
                  <li>
                ...
                <Typography
                  variant="body1"
                  pargraph
                  sx={{ mb: 1, mt: 2, fontSize: "22px", color: "#E2CAA2" }}
                >
                  <strong>
                ...
                <Typography
                  variant="body1"
                  pargraph
                  sx={{ fontSize: "18px", mb: 3, color: "#E2CAA2" }}
                >
          ...
          <Box sx={{ mb: 2, border: `1px solid #E2CAA2`, borderRadius: "5px" }}>
            <Accordion
              ...
              onChange={() => handleToggle("accordion13")}
              sx={{
                "&:before": { display: "none" }, // Remove default divider line
                backgroundColor: "transparent",
              }}
          ...
          <Box sx={{ mb: 2, border: `1px solid #E2CAA2`, borderRadius: "5px" }}>
            <Accordion
              ...
              onChange={() => handleToggle("accordion14")}
              sx={{
                "&:before": { display: "none" }, // Remove default divider line
                backgroundColor: "transparent",
              }}
          ...
          <Box sx={{ mb: 2, border: `1px solid #E2CAA2`, borderRadius: "5px" }}>
            <Accordion
              ...
              onChange={() => handleToggle("accordion15")}
              sx={{
                "&:before": { display: "none" }, // Remove default divider line
                backgroundColor: "transparent",
              }}
          ...
          <Box sx={{ mb: 2, border: `1px solid #E2CAA2`, borderRadius: "5px" }}>
            <Accordion
              ...
              onChange={() => handleToggle("accordion16")}
              sx={{
                "&:before": { display: "none" }, // Remove default divider line
                backgroundColor: "transparent",
              }}
          ...
          <Box sx={{ mb: 2, border: `1px solid #E2CAA2`, borderRadius: "5px" }}>
            <Accordion
              ...
              onChange={() => handleToggle("accordion17")}
              sx={{
                "&:before": { display: "none" }, // Remove default divider line
                backgroundColor: "transparent",
              }}
          ...
          <Box sx={{ mb: 2, border: `1px solid #E2CAA2`, borderRadius: "5px" }}>
            <Accordion
              ...
              onChange={() => handleToggle("accordion18")}
              sx={{
                "&:before": { display: "none" }, // Remove default divider line
                backgroundColor: "transparent",
              }}
          ...
          <Box sx={{ mb: 2, border: `1px solid #E2CAA2`, borderRadius: "5px" }}>
            <Accordion
              ...
              onChange={() => handleToggle("accordion19")}
              sx={{
                "&:before": { display: "none" }, // Remove default divider line
                backgroundColor: "transparent",
              }}
          ...
          <Box sx={{ mb: 2, border: `1px solid #E2CAA2`, borderRadius: "5px" }}>
            <Accordion
              ...
              onChange={() => handleToggle("accordion20")}
              sx={{
                "&:before": { display: "none" }, // Remove default divider line
                backgroundColor: "transparent",
              }}
          ...
          <Box sx={{ mb: 2, border: `1px solid #E2CAA2`, borderRadius: "5px" }}>
            <Accordion
              ...
              onChange={() => handleToggle("accordion21")}
              sx={{
                "&:before": { display: "none" }, // Remove default divider line
                backgroundColor: "transparent",
              }}
          ...
          <Box sx={{ mb: 2, border: `1px solid #E2CAA2`, borderRadius: "5px" }}>
            <Accordion
              ...
              onChange={() => handleToggle("accordion22")}
              sx={{
                "&:before": { display: "none" }, // Remove default divider line
                backgroundColor: "transparent",
              }}
